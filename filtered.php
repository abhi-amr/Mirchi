...
$query = "select * from menu where type=".$category.";";
...
<body>
  ...
  <header class="container-fluid">
        ...
        <div class="col-1"><a href="customerprofile.php"><i class="fas fa-user-alt float-right"></i></a></div>
        </div>
       <nav class="row">
          <div class="col-12">
           <ul>
    ...
    <div class="container card">
        <div class="row list">
            ...
            <div class="col-8">
                ...
                <div class="row"><div class="col-12 product-title"><a href="product.php?id=<?php echo $productdata['pid'] ?>" style="color:black"><h3><?php echo ucwords($menu['items']); ?></h3></a></div></div>
